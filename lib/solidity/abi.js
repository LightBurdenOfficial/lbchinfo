...
const lpp20List = require('./lpp20-abi.json')
const lpp721List = require('./lpp721-abi.json')
...
const lpp20ABIs = transformABIList(lpp20List)
const lpp721ABIs = transformABIList(lpp721List)

Object.assign(exports, {MethodABI, EventABI, lpp20ABIs, lpp721ABIs})
